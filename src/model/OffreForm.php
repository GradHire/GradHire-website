...
class OffreForm extends Model
{
	 ...
	 */
	public static function creerOffre(Offre $offre, ?string $typeStage, ?string $typeAlternance, ?float $distanciel): true
	{
 ...
 <a href="' . HOST . '/offres/' . $id . '">Voir l\'offre</a>
	 ...
	 * @throws ServerErrorException
	 */
	public static function deleteOffre(mixed $idOffre): bool
	{
