...
HTML;
    ...
    {
        echo <<<HTML
<button type="submit" class="h-[44px] px-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center justify-center">
    <svg aria-hidden="true" role="statut" class="hidden w-4 h-4 mr-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
HTML;
    ...
    {
        echo '<button onclick="window.location = window.location.href" class="text-white bg-zinc-700 hover:bg-zinc-800 focus:ring-4 focus:outline-none focus:ring-zinc-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-zinc-600 dark:hover:bg-zinc-700 dark:focus:ring-zinc-800">
            ' . $text . '
        </button>';
    }
...
HTML;
    ...
    public function start(): void
    {
        ...
        echo <<<HTML
<form action="$this->action" method="$this->method" $enctype onsubmit="document.querySelector('button[type=submit] svg').style.display = 'inline';">
HTML;
    }
