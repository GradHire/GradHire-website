...
?>
<div class="w-full">
    <div class="w-full flex flex-col max-w-lg mx-auto justify-center mt-5">
        ...
        <div class="flex flex-col md:flex-row gap-2 w-full">
            <a href="simulateur"
               class="bg-red-500 hover:bg-red-600  w-full text-white  text-nowrap py-2 px-4 rounded-md">Recommencer</a>

            <a href="validersimulation" id="validerSimulation"
               class="bg-green-500 hover:bg-green-600 text-white text-nowrap py-2 px-4 w-full rounded-md">Valider
                simulation</a>
        </div>
