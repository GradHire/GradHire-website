...
<div class="flex w-full">
    <div class="flex flex-row items-center justify-between w-full"><p> Le tuteur n'existe pas encore ?</p><a
                href="/creerTuteur"
                class="ml-3 inline-block rounded bg-zinc-800 px-4 py-2 w-fit text-xs font-medium text-white hover:bg-zinc-900">Créer-le</a>
    </div>
</div>
