    ...
    <div class="flex mt-8">
        <form method="POST" action="">
            <button type="submit" name="tab" value="tab1"
                    class="py-2 px-4 rounded-l <?php if ($currentTab === 'tab1') echo 'bg-blue-500 text-white'; else echo 'bg-gray-200 text-gray-800'; ?>">
                Tab 1
            </button>
            <button type="submit" name="tab" value="tab2"
                    class="py-2 px-4 <?php if ($currentTab === 'tab2') echo 'bg-blue-500 text-white'; else echo 'bg-gray-200 text-gray-800'; ?>">
                Tab 2
            </button>
            <button type="submit" name="tab" value="tab3"
                    class="py-2 px-4 rounded-r <?php if ($currentTab === 'tab3') echo 'bg-blue-500 text-white'; else echo 'bg-gray-200 text-gray-800'; ?>">
                Tab 3
            </button>
        </form>
    </div>
