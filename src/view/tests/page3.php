...
?>
<div class="mx-auto  pb-24 w-full lg:flex">
    <div class="flex overflow-x-auto border-b border-zinc-900/5 py-4 lg:block lg:w-64 lg:flex-none lg:border-0 lg:border-r lg:py-20">
        <nav class="flex-none px-4 lg:mr-2 sm:px-6 lg:px-0">
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
                    <div class="text-xs font-semibold leading-6 text-zinc-400">Categories</div>
                            ...
                            <a href=""
                               class=" text-zinc-700 group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold hover:bg-zinc-200">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     stroke-width="1.5" stroke="currentColor" class="h-6 w-6 shrink-0 text-zinc-700">
                ...
                <li>
                    <div class="text-xs font-semibold leading-6 text-zinc-400">Actions</div>
                    <ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
                        <li>
                            <a href=""
                               class="text-zinc-700 group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold hover:bg-zinc-200">
        ...
        <div class="relative isolate overflow-hidden pt-16">
            <header class="pb-4 pt-6 sm:pb-6">
                <div class="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
                    <h1 class="text-base font-semibold leading-7 text-gray-900">Statistiques</h1>
                    <div class="order-last flex w-full gap-x-8 text-sm font-semibold leading-6 sm:order-none sm:w-auto sm:border-l sm:border-gray-200 sm:pl-6 sm:leading-7">
                        <a href="#" class="text-blue-600">Dernier semaine</a>
                        <a href="#" class="text-gray-700">Dernier mois</a>
                        <a href="#" class="text-gray-700">Tout le temps</a>
                    </div>
                    <a href="#"
            ...
            <div class="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/5">
                <dl class="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:px-2 xl:px-0">
                    <div class="flex items-baseline flex-wrap justify-between gap-y-2 gap-x-4 border-t border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8">
                        <dt class="text-sm font-medium leading-6 text-gray-500">...</dt>
            ...
            <div class="absolute left-0 top-full -z-10 mt-96 origin-top-left translate-y-40 -rotate-90 transform-gpu opacity-20 blur-[80px] sm:left-1/2 sm:-ml-96 sm:-mt-10 sm:translate-y-0 sm:rotate-0 sm:transform-gpu sm:opacity-50"
                 aria-hidden="true">
                <div class="aspect-[2154/478] w-[50.125rem] bg-gradient-to-br from-[#004cc8] to-[#00bfff]"
                                ...
                                <tr>
                                    ...
                                    <td class="py-5 text-right">
                                        <div class="flex justify-end">
                                            <a href="#"
                                               class="text-sm font-medium leading-6 text-blue-600 hover:text-blue-500">View<span
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm font-semibold leading-6 text-blue-600 hover:text-blue-500">View
