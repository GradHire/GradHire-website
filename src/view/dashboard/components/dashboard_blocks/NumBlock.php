...
class NumBlock
{
...

    {
        ...
        echo <<<EOT
        <div class="px-4 py-2 w-full min-w-[150px] max-h-[75px] border border-zinc-200 shadow bg-white rounded-[8px] flex flex-col justify-around items-start relative">
