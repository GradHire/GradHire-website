...
<div class="w-full">
    <div class="w-full flex md:flex-row flex-col justify-between items-start">
        ...
        <div class="flex flex-row gap-4">
            ...
            echo("<a href=\"/edit_profile/" . $utilisateur->getIdutilisateur() . "\" class=\"cursor-pointer inline-block px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 focus:relative\">
