...
<form method="POST" name="save" action="/edit_profile/<?= $utilisateur->getIdutilisateur() ?>" class="mt-6 border-t border-gray-100 w-full" id="detailUtilisateur">
    <div class="w-full flex md:flex-row flex-col justify-between items-start">
        ...
        <div>
            <td class="whitespace-nowrap px-4 py-2">
                <button type="submit" value="edit" name="edit" id="buttunEdit" class="inline-block rounded bg-orange-400 px-4 py-2 text-xs font-medium text-white hover:bg-zinc-700">Edit</button>
            </td>
            <td class="whitespace-nowrap px-4 py-2">
