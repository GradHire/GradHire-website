  ...
  <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="relative bg-zinc-900 bg-opacity-75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
                    <div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                        ...
                        <p class="mt-3 text-xl text-white">Nous vous aidons à trouver le stage ou l'alternance qui vous
                            convient le mieux. Vous pouvez également trouver des candidats pour votre entreprise.</p>
                        <a href="/offres"
        ...
        <section aria-labelledby="testimonial-heading" class="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
            <div class="mx-auto max-w-2xl lg:max-w-none">
                <h2 id="testimonial-heading" class="text-2xl font-bold tracking-tight text-gray-900">Ce que les gens
                    disent</h2>
                ...
                <div class="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
                    <blockquote class="sm:flex lg:block">
                        ...
                        <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                            ...
                            <cite class="mt-4 block font-semibold not-italic text-gray-900">Lionel Messi, Barcelone</cite>
                        </div>
                    </blockquote>
                    <blockquote class="sm:flex lg:block">
                        <svg width="24" height="18" viewBox="0 0 24 18" aria-hidden="true" class="flex-shrink-0 text-gray-300">
                        ...
                        <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                            <p class="text-lg text-gray-600">Je n'ai pas eu de chance avec les autres sites, mais
                                GradHire m'a aidé à trouver un stage en quelques semaines.</p>
                            <cite class="mt-4 block font-semibold not-italic text-gray-900">Cristiano Ronaldo, Turin</cite>
                        </div>
                    </blockquote>
                    <blockquote class="sm:flex lg:block">
                        <svg width="24" height="18" viewBox="0 0 24 18" aria-hidden="true" class="flex-shrink-0 text-gray-300">
