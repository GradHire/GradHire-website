...
<div class="hidden" id="step3">
    ...
    <div class="w-full max-w-md gap-4 flex flex-col gap-4 mx-auto ">
        <div class="w-full gap-4 flex flex-col">
            ...
            <button type="button" onclick="nextStep('step3', 'step4')">Suivant</button>
        </div>
    </div>
</div>
<div class="hidden" id="step4">
    ...
    <div class="w-full max-w-md gap-4 flex flex-col gap-4 mx-auto ">
        <div class="w-full gap-4 flex flex-col">
            ...
            ?>
            <button type="button" onclick="prevStep('step4', 'step3')">Précédent</button>
            <button type="button" onclick="nextStep('step4', 'step5')">Suivant</button>
        </div>
    </div>
</div>
<div class="hidden" id="step5">
    ...
    <div class="w-full max-w-md gap-4 flex flex-col gap-4 mx-auto ">
        <div class="w-full gap-4 flex flex-col">
            ...
            ?>
            <button type="button" onclick="prevStep('step5', 'step4')">Précédent</button>
            <button type="button" onclick="nextStep('step5', 'step6')">Suivant</button>
        </div>
    </div>
</div>
<div class="hidden" id="step6">
    ...
    <div class="w-full max-w-md gap-4 flex flex-col gap-4 mx-auto ">
        <div class="w-full gap-4 flex flex-col">
            ...
            ?>
            <button type="button" onclick="prevStep('step6', 'step5')">Précédent</button>
            <button type="button" onclick="nextStep('step6', 'step7')">Suivant</button>
        </div>
    </div>
</div>
<div class="hidden" id="step7">
    ...
    <div class="w-full max-w-md gap-4 flex flex-col gap-4 mx-auto ">
        <div class="w-full gap-4 flex flex-col">
            ...
            ?>
            <button type="button" onclick="prevStep('step7', 'step6')">Précédent</button>
            <?php
            $form->submit("Envoyer");
            ?>
        </div>
