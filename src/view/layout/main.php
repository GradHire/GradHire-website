...
<head>
    ...
    <script type="text/javascript" src="/resources/js/animate-sidemenu.js"></script>
...
<div class="w-full flex justify-start items-start bg-zinc-50 flex-row duration-300">
    <div id="sidebar-container" class="duration-300 ease-out relative text-[14px] w-full
    <?php if (!isset($_COOKIE['sidebar_open']) || $_COOKIE['sidebar_open'] === 'true') echo 'max-w-[275px]'; else echo 'max-w-[75px]'?>
    m-0 bg-white isolate justify-around border-r text-[#1A2421] backdrop-blur-xl p-4 [ shadow-black/5 shadow-2xl ] fixed top-0 left-0 z-40 h-screen ">
        <div class="h-full justify-between items-start w-full flex gap-8 flex-col ">
            <div class="flex flex-row w-full justify-between">
                <a href="/">
                    <span class="sr-only">GradHire</span>
                    <svg id="logo-big" class="h-7 pl-4 w-auto fill-zinc-800" width="532" height="159"
                         viewBox="0 0 532 159" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg id="logo-small" class="h-7 pl-4 w-auto fill-zinc-800" width="156" height="238"
                         viewBox="0 0 156 238" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="submit" name="sidebar-icon" id="sidebar-button"
                        class="h-7 w-7 justify-center items-center flex cursor-pointer group duration-150 ease-out">
                    ...
                    <svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path class="sidebar-path-to-spin
    <?php if (!isset($_COOKIE['sidebar_open']) || $_COOKIE['sidebar_open'] === 'true') echo 'rotate-0 translate-x-0 translate-y-0'; else echo 'rotate-180 translate-x-[28px] translate-y-[20px]'?>

" d="M15.75 13.5L12 9.75L15.75 6" stroke-width="1.5"
