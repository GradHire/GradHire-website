...
<div class="w-full flex justify-start items-start bg-zinc-50 flex-row duration-300">
    <div id="sidebar-container" class="duration-300 ease-out relative text-[14px] w-full <?= $isOpen ? " max-w-[275px] " : " max-w-[100px] " ?> m-0 bg-white justify-around border-r text-[#1A2421] backdrop-blur-xl p-4 [ shadow-black/5 shadow-2xl ] fixed top-0 left-0 z-40 h-screen ">
        <div class="h-full justify-between items-start w-full flex gap-8 flex-col relative ">
            <div class="flex flex-row w-full justify-between">
                <a href="/">
                    ...
                    <svg id="logo-big" class="h-7 pl-4 w-auto fill-zinc-800" style="display: <?= $isOpen ? "block" : "none" ?>"
                    ...
                    <svg id="logo-small" class="h-7 pl-4 w-auto fill-zinc-800" style="display: <?= $isOpen ? "none" : "block" ?>"
                ...
                <button type="submit" name="sidebar-icon" id="sidebar-button"
                    ...
                    <svg width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path class="sidebar-path-to-spin <?= $isOpen ? " rotate-0 translate-x-0 translate-y-0" : " rotate-180 translate-x-[28px] translate-y-[20px]"?>" d="M15.75 13.5L12 9.75L15.75 6" stroke-width="1.5"
                              stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
            </div>
            <div class="h-full w-full z-40 flex gap-2 flex-col relative">
                <div class="w-full flex flex-row justify-between items-center">
                    ...
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                             class="w-5 h-5 hover:fill-zinc-800 fill-zinc-400 duration-300 sectionAdd" style="display: <?= $isOpen ? "block" : "none" ?>">
                ...
                <div class="w-full flex flex-row justify-between items-center">
                    ...
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style="display: <?= $isOpen ? "block" : "none" ?>"
