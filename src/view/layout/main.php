    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        ...
        <div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
            <ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                ...
                <!--                        </svg>-->
                <!--                    </div>-->
                <!--                    <div id="company-dropdown" class="hidden absolute z-10 w-auto grid-cols-1 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700  dark:bg-gray-700">-->
                <!--                        <div class="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">-->
                <!--                            <ul class="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">-->
                <!--                                <li>-->
                <!--                                    <a href="#" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-500 group">-->
                <!--                                        <span class="sr-only">About us</span>-->
                <!--                                        <svg class="w-3 h-3 mr-2 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">-->
                ...
                <!--                                        <svg class="w-3 h-3 mr-2 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">-->
