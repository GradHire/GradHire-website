...
<div class="w-full flex justify-start items-start bg-zinc-50 flex-row duration-300">
    <div id="sidebar-container"
        ...
        <div class="h-full justify-between items-start w-full flex gap-8 flex-col relative ">
            <div class="flex flex-row w-full items-center justify-center ">
                <a class="w-full " href="/">
                    ...
                    <svg id="logo-big" class="h-7 w-auto mr-auto fill-zinc-800 "
                    ...
                    <svg id="logo-small" class="h-7 w-auto mx-auto fill-zinc-800"
        ...
        <button type="submit" name="sidebar-icon" id="sidebar-button" class=" h-full w-4 absolute right-0 group top-0 translate-x-4 ">
            <div class="flex h-6 w-6 flex-col items-center absolute  duration-150 right-0 top-1/2 transform -translate-y-1/2 translate-x-1.5">
                <div id="sideButtonFlash1" class=" h-3 w-1 rounded-full duration-150 bg-zinc-400 group-hover:bg-zinc-800 <?= $isOpen ? " group-hover:rotate-[15deg] group-hover:-translate-x-0.5 " : " group-hover:-rotate-[15deg] group-hover:translate-x-0.5 " ?> translate-y-0.5"></div>
                <div id="sideButtonFlash2" class=" h-3 w-1 rounded-full duration-150 bg-zinc-400 group-hover:bg-zinc-800 <?= $isOpen ? " group-hover:-rotate-[15deg] group-hover:-translate-x-0.5 " : " group-hover:rotate-[15deg] group-hover:translate-x-0.5 " ?> -translate-y-0.5"></div>
            </div>
        </button>
    </div>
