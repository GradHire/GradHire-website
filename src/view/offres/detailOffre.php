...
<div class="lg:flex lg:items-center lg:justify-between">
    <div class="min-w-0 flex-1">
        ...
        <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
            ...
            <div class="mt-2 flex items-center text-sm text-gray-500">
                ...
                <?= $offre->getGratification() ?> € / <?= $offre->getUnitegratification() ?>
            </div>
            <div class="mt-2 flex items-center text-sm text-gray-500">
                <svg class="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" viewBox="0 0 20 20" fill="currentColor"
                     aria-hidden="true">
    ...
    <div class="flex justify-end lg:ml-4 lg:mt-0">
  ...
  <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <span class="sm:ml-3">
      <button type="button"
              class="inline-flex items-center rounded-md bg-zinc-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-zinc-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-600">
        ...
        <div class="relative ml-3 sm:hidden">
            ...
            <div style="display: none;"
                 class="dropdown-menu absolute right-0 z-10 -mr-1 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                 role="menu" aria-orientation="vertical" aria-labelledby="mobile-menu-button" id="dropdown-menu"
                 tabindex="-1">
                <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                   id="mobile-menu-item-0">Modifier</a>
                <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                   id="mobile-menu-item-1">Supprimer</a>
            </div>
        </div>
    </div>
</div>
