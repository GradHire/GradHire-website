<div class="w-full flex flex-col max-w-[50%]">
    <form action="creeroffre" method="post">
        <div class="w-full gap-4 flex flex-col">

            <div class="flex mt-4">
                <label class="flex items-center">
                    <input type="radio" class="form-radio" name="radios" value="stage" required onchange="showDistanciel()">
                    <span class="ml-2">Stage</span>
                </label>
                <label class="flex items-center ml-6">
                    <input type="radio" class="form-radio" name="radios" value="alternance" id="alternanceRadio" required onchange="showDistanciel()">
            ...
            <select name="theme" id="theme" required
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500 dark:shadow-sm-light">
            ...
            <textarea name="description" id="description" cols="30" rows="10" required
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500 dark:shadow-sm-light "></textarea>

            <input type='hidden' name='action' value='createoffre'>
            <input type="submit" value="Envoyer" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800"/>
        </div>
    </form>
</div>
<script>
