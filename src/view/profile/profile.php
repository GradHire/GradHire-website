    ...
    <aside class="flex overflow-x-auto border-b border-zinc-900/5 py-4 lg:block lg:w-64 lg:flex-none lg:border-0 lg:py-20">
        <nav class="flex-none px-4 sm:px-6 lg:px-0">
            <ul role="list" class="flex gap-x-3 gap-y-1 whitespace-nowrap lg:flex-col">
                ...
                <li>
                    <a href=""
                       class="bg-zinc-50 text-zinc-600 group flex gap-x-3 rounded-md py-2 pl-2 pr-3 text-sm leading-6 font-semibold">
            ...
            <div>
                <div class="flex flex-row gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm leading-6 text-zinc-500">Cettes informations seront partagées avec les
                            autres
                            utilisateurs.</p>
                    </div>
                </div>
